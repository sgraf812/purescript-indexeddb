          ...
          return function (upgrade) {
              return Control_Monad_Aff.makeAff(function (error) {
                  return function (success) {
                      return $foreign.openIDBNative(name, version, success, error, function (old) {
                          return function ($$new) {
                              return function (db) {
...
(function(exports) {
  ...
  var upgrade = function (evt) {
      return function __do() {
          ...
          Control_Monad_Eff_Console.print(Prelude.showInt)(evt.old)();
          Control_Monad_Eff_Console.print(Prelude.showInt)(evt["new"])();
          return Prelude.unit;
      };
  };
  var main = Control_Monad_Aff.launchAff(Prelude.bind(Control_Monad_Aff.bindAff)(Control_Monad_Aff.attempt(IndexedDB.open("hi")(1)(upgrade)))(function (_0) {
      return Data_Either.either(Prelude["const"](Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("error"))))(Prelude["const"](Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Console.log("success"))))(_0);
  }));
  exports["main"] = main;
